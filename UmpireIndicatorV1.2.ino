...
void updateBalls(int newBalls) {
  ...
  // if (pBallCharacteristic != nullptr) {
  //   // Make sure new strikes value is within bounds
  //   newBalls = newBalls % 5;
  //   if (newBalls >= 0 && newBalls <= 4) {
  //     // Update the value of strikes
  ...
  //     // Update the BLE characteristic
  //     char ballsValue[4];                         // Assuming maximum of 3 digits for strikes count and a null terminator
  //     itoa(currentGame.balls, ballsValue, 10);  // Convert integer to string
  //     pBallCharacteristic->setValue(ballsValue);

  //     // Notify connected clients about the update
  //     pBallCharacteristic->notify();
  //   }
  // } else {
  //   Serial.println("Error: pBallCharacteristic == null");
  // }
}
